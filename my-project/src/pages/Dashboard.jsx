...
export default function Dashboard() {
    ...
    return (
      <>
        <div className="flex flex-col h-[100vh] items-center justify-center">
          <div className="h-8 w-8 animate-spin rounded-full border-4 border-secondary border-t-black"></div>
  ...
  //         }}
  //         className="border rounded border-red-500 mt-2 px-4 py-2"
  //       >
  //         Retry
  //       </button>
  //     </div>
    ...
    <MainLayout>
      <div className="">
        <div className="flex mb-5 items-center justify-between">
          <h2 className="text-2xl font-bitter font-bold text-primary">Connected Websites</h2>
          <button
            onClick={handleAddNewWebsite}
            className="px-4 py-2 text-white bg-primary hover:bg-secondary rounded font-semibold"
          >
            + Add New Website
          </button>
        </div>
        ...
        {showAlert && (
          <div className="fixed inset-0 bg-primary bg-opacity-60 flex items-center justify-center z-50">
            <div className="bg-white rounded p-6 w-[90%] max-w-md space-y-4">
              ...
              <div className="flex justify-end space-x-4">
                <button
                  ...
                  className="px-4 py-2 border rounded text-gray-700 border-secondary"
                >
                  Cancel
                </button>
                <button
